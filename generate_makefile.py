...
with open("Makefile", "w") as f:
	...
	for width in CUTOUT_WIDTHS:
		for depth in CUTOUT_DEPTHS:
			f.write(f"\n\tstls/square_actuator_{width}w_{depth}d.stl\\")
	...
	for width in CUTOUT_WIDTHS:
		for depth in CUTOUT_DEPTHS:
			f.write(f"\n\nstls/square_actuator_{width}w_{depth}d.stl: stls/.directory_marker concave_actuator.scad")
			f.write(f"\n\t${{OPENSCAD}} -D CUTOUT_WIDTH={width} -D CUTOUT_DEPTH={depth} -o $@ concave_actuator.scad")
